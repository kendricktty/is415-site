...
The process will continue in [Hands-on exercise 8](hands-on-8.qmd). Before we conclude, we need to save the `shan_sf` object from earlier to the disk so that we can refer to it again.
