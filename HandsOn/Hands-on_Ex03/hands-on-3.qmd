...
While first order SPPA measures how observations vary due to *changes in the underlying property*, **second order SPPA** deals with variations in observations *due to the way they interact with one another*. The methods used for second order SPPA include the G-, F-, K- and L-functions.
