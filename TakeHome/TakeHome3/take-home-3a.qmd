---
title: "TH3a: Take-Home Exercise 3 post-feedback"
subtitle: "Take Home Exercise 3a"
author: "Kendrick Teo"
date: "2024-11-11"
...
ggplot(median_values, aes(x = `Property Type`, y = median)) +
  ...
  coord_flip()
```
Most transactions in the 2-year period between 2023 and 2024 involved **2 - 2 1/2 storey terraced houses**. The highest median values 
