...
The code chunk below computes Moran's I on both our drug use and drug trafficking datasets, subsequently performing a Monte Carlo test.

```{r}
moran.test(thailand_2021$total_use_cases, listw=wm_q_use, zero.policy = TRUE, na.action=na.omit)
```
