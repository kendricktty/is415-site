...
The following code chunks create a filtered table for the *confirmed* drug use and trafficking observations, groups and summarises them by province, and plots the numbers onto the provincial map of Thailand.
