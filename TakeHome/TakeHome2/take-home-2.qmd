...
```
The provinces with the highest number of drug use cases appear clustered to the northeast, around Sakon Nakhon, and north, around Chiang Mai and Chiang Rai, with pockets of high use around the capital Bangkok and the southern provinces. Meanwhile, the eastern province of Ubon Ratchatani sees the largest number of *trafficking* cases overall.

We will now proceed to rigourously verify these observations using spatial autocorrelation techniques.
