...
We will create 2 spatial weights matrices - one for our drug use statistics and another for drug trafficking statistics.

```{r}
thailand_2021_use <- thailand_2021 %>% select(1:3, 17)
thailand_2021_trafficking <- thailand_2021 %>% select(1:3, 18)
wm_q <- poly2nb(thailand_2021_use, queen=TRUE)
```
