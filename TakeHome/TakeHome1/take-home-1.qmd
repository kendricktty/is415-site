...
Myanmar is organised into seven **states**, seven **regions**, and one union territory encompassing the capital **Naypyitaw**. The following code chunk plots the administrative divisions of Myanmar into an interactive map.
