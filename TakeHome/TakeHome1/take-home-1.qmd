...
## TH1.5 First Order STPPA - Spatial-Temporal KDE

Our approach today will be to identify areas of consistently high conflict using spatial-temporal kernel density estimation (KDE). We can then zoom in on these areas for deeper research on why this is the case.
