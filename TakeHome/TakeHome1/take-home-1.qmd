...
```{r}
tm_shape(raster) + tm_raster("layer", palette = "viridis") 
...
Second order SPPA investigates variations in observations due to the way they interact with one another. In this section, we will use the F, G, K and L-functions to analyse the spatial point patterns in our 6 selected regions.
